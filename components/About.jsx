        ...
        <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
            <div className='col-span-2'>
                ...
                <p className='text-white py-2'>
                    ...
                    Engineer and a project manager in construction. I have always had a gift for client relations and negotiations
                ...
                <p className='text-white py-2 underline cursor-pointer'>Check out some of my projects.</p>
            </div>
